...
real, parameter   :: AMPA = 0.000000 
real, parameter   :: AMPB = 5.000000 
integer, parameter   :: wprofile = 2 
integer, parameter   :: ttotmin = 150 
integer, parameter   :: n_iceCat = 2 
real, parameter :: qitop = 0.001433 
real, parameter :: qltop = 0.000000 
real, parameter :: qgtop = 0.000000 
real, parameter :: bgtop = 0.000000 
real, parameter :: nitop = 1147.154365 
